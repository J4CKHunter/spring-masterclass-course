...
public class AdminController {
    ...
    public ModelAndView displayStudents(Model model, @RequestParam int classId, HttpSession httpSession,
        ...
        if(error != null){
            errorMessage = "olmayan email girildi";
...
//        List<Courses> courses = coursesRepository.findByOrderByCourseId();

//        List<Courses> courses = coursesRepository.findByOrderByCourseIdDesc();
